    ...
    $.jqplot = function(target, data, options) {
        ...
        if ($.jqplot.config.catchErrors) {
            try {
                ...
                target.style.background = $.jqplot.config.errorBackground;
                target.style.border = $.jqplot.config.errorBorder;
                target.style.fontFamily = $.jqplot.config.errorFontFamily;
                target.style.fontSize = $.jqplot.config.errorFontSize;
                target.style.fontStyle = $.jqplot.config.errorFontStyle;
                target.style.fontWeight = $.jqplot.config.errorFontWeight;
                /*
