...
//initialize AppMeasurement
	...
	if ((window.location.host.indexOf("sciverse-shindig") === 0 || window.location.host.indexOf("elsevier-apps.sciverse.com") === 0 || window.location.host.indexOf("authortools.elsevier.com") === 0) && scGadProm === true)  {
		//s.tagContainerEnv="prod"; //this line commented out on purpose
		s_account = "elseviergadget-prod";
	}else {
		s_account = "elseviergadget-dev";
	}    
